...
let package = Package(
  ...
  products: [
    ...
    .library(name: "SwiftCompilerPlugin", type: .dynamic, targets: ["SwiftCompilerPlugin"]),
    .library(name: "SwiftCompilerPluginMessageHandling", type: .dynamic, targets: ["SwiftCompilerPluginMessageHandling"]),
    .library(name: "SwiftDiagnostics", type: .dynamic, targets: ["SwiftDiagnostics"]),
    .library(name: "SwiftIDEUtils", type: .dynamic, targets: ["SwiftIDEUtils"]),
    .library(name: "SwiftOperators", type: .dynamic, targets: ["SwiftOperators"]),
    .library(name: "SwiftParser", type: .dynamic, targets: ["SwiftParser"]),
    .library(name: "SwiftParserDiagnostics", type: .dynamic, targets: ["SwiftParserDiagnostics"]),
    .library(name: "SwiftRefactor", type: .dynamic, targets: ["SwiftRefactor"]),
    .library(name: "SwiftSyntax", type: .dynamic, targets: ["SwiftSyntax"]),
    .library(name: "SwiftSyntaxBuilder", type: .dynamic, targets: ["SwiftSyntaxBuilder"]),
    .library(name: "SwiftSyntaxMacros", type: .dynamic, targets: ["SwiftSyntaxMacros"]),
    .library(name: "SwiftSyntaxMacroExpansion", type: .dynamic, targets: ["SwiftSyntaxMacroExpansion"]),
    .library(name: "SwiftSyntaxMacrosTestSupport", type: .dynamic, targets: ["SwiftSyntaxMacrosTestSupport"]),
  ],
  targets: [
